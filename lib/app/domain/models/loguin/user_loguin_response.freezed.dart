...
class _$UserLoginResponseImpl implements _UserLoginResponse {
  ...
  @override
  String toString() {
    return 'UserLoginResponse(id: $id, username: $username, password: $password, name: $name, apellido: $apellido, telefono: $telefono, email: $email, fechaCreacion: $fechaCreacion, role: $role, token: $token)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, username, password, name,
      apellido, telefono, email, fechaCreacion, role, token);
...
abstract class _UserLoginResponse implements UserLoginResponse {
  const factory _UserLoginResponse(
      ...
      final String? fechaCreacion,
      final String? role,
      final String? token}) = _$UserLoginResponseImpl;
