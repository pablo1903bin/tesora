...
part 'crear_cooperacion_dto.g.dart';

@JsonSerializable()
class CrearCooperacionDto {
  final String? nombre;
  ...
  factory CrearCooperacionDto.fromJson(Map<String, dynamic> json) =>
      _$CrearCooperacionDtoFromJson(json);

  Map<String, dynamic> toJson() => _$CrearCooperacionDtoToJson(this);
}
